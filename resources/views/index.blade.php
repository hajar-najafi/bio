...
<header class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        ...
        <!-- Masthead Heading-->
        <h1 style="font-size: 40px" class="masthead-heading text-uppercase mb-0">Hajar Najafi Marghmaleki</h1>
        <!-- Icon Divider-->
        ...
        <!-- Masthead Subheading-->
        <p style="font-size: 40px" class="masthead-subheading font-weight-light mb-0">junior web developer</p>
    </div>
</header>
<!-- Portfolio Section-->
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-5 mb-lg-0">
                ...
                <a class="btn btn-outline-light btn-social mx-1" href="https://www.linkedin.com/in/hajar-najafi-235230175/"><i class="fab fa-fw fa-linkedin-in"></i></a>
                <a class="btn btn-outline-light btn-social mx-1" href="https://www.instagram.com/hajar.najafi/"><i class="fab fa-instagram"></i></a>
